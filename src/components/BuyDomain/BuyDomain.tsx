      ...
      >
        ...
        <div className="buy-domain">
          <div className="buy-domain__register">
            <span className="material-symbols-outlined buy-domain__register-icon">
              language
            </span>
            <div className="buy-domain__register-data">
              <p className="buy-domain__register-data-title p3">
                Регистрируется домен
              </p>
              {typeof domain != undefined && (
                <p className="buy-domain__register-data-dname h4">
                  {domain?.dname}
                </p>
              )}
            </div>
          ...
          >
            ...
            >
              <Form.Item<FieldType>
                ...
                rules={[
                  {
                    required: true,
                    message: "Необходимо ввести период регистрации",
                  },
                ]}
              >
                <Select
                ...
                <InputWrapper label="NS1 сервер" id="domain_register_ns1">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        max: 20,
                        message: "Максимальный размер ns записи 20 символов",
                      },
                    ]}
                  >
                    <Input
                      type="text"
                      id="domain_register_ns1"
                      placeholder="NS1 сервер"
                    />
                  </Form.Item>
                </InputWrapper>
              </Col>
              <Col span={24} lg={12}>
                <InputWrapper label="NS2 сервер" id="domain_register_ns2">
                  ...
                  >
                    <Input
                      type="text"
                      id="domain_register_ns2"
                      placeholder="NS2 сервер"
                    />
                  </Form.Item>
                </InputWrapper>
              </Col>
            ...
            <div className="buy-domain-part">
              <p className="buy-domain-part__title h5">Данные владельца</p>
            </div>
            <Row gutter={[16, 8]}>
                ...
                <InputWrapper label="Имя *" id="domain_register_first_name">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        max: 50,
                        message: "Максимальный размер имяни 50 символов",
                      },
                ...
                <InputWrapper label="Фамилия *" id="domain_register_last_name">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        max: 50,
                        message: "Максимальный размер фимили 50 символов",
                      },
                      {
                        min: 2,
                        message: "Минимальный размер фимилии 2 символа",
                      },
                    ]}
                  >
                    <Input
                      type="text"
                      id="domain_register_last_name"
                      placeholder="Фамилия"
                    />
                  </Form.Item>
                </InputWrapper>
                ...
                <InputWrapper label="Отчество" id="domain_register_second_name">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        min: 2,
                        message: "Минимальный размер отчества 2 символа",
                      },
                    ]}
                  >
                    <Input
                      type="text"
                      id="domain_register_second_name"
                ...
                <InputWrapper label="Email *" id="domain_register_email">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        max: 100,
                        message: "Максимальный размер email 100 символов",
                      },
                    ]}
                  >
                    <Input
                      id="domain_register_email"
                      type="email"
                      placeholder="Email"
                    />
                  </Form.Item>
            ...
            <Row gutter={[16, 8]}>
              <Col span={24} lg={12}>
                <InputWrapper
                  ...
                  id="domain_register_passpor_serial_number"
                >
                  <Form.Item<FieldType>
              ...
              <Col span={24} lg={12}>
                ...
                >
                  <Form.Item<FieldType> name="dateBirth">
                    <DatePicker
                      id="domain_register_date_birth"
                      style={{ width: "100%" }}
                    />
            ...
            <Row gutter={[16, 8]}>
              <Col span={24} lg={12}>
                ...
                >
                  <Form.Item<FieldType> name="dateGetPassport">
                    <DatePicker
                      id="domain_register_date_get_passport"
                      style={{ width: "100%" }}
                    />
              ...
              <Col span={24} lg={12}>
                <InputWrapper
                  label="Кем выдан"
                  id="domain_register_issued_by_passport"
                >
                  <Form.Item<FieldType>
                ...
                <InputWrapper label="Индекс" id="domain_register_index">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      {
                        pattern: /\d+/,
                        message: "Индекс должен состоять из цифр",
                      },
                ...
                <InputWrapper label="Город" id="domain_register_city">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        min: 2,
                        message: "Минимальный размер города 2 символа",
                      },
                    ]}
                  >
                    <Input
                      type="text"
                      id="domain_register_city"
                      placeholder="Город"
                    />
                  </Form.Item>
                </InputWrapper>
                ...
                <InputWrapper label="Область" id="domain_register_region">
                  <Form.Item<FieldType>
                    ...
                    rules={[
                      ...
                      {
                        min: 2,
                        message: "Минимальный размер области 2 символа",
                      },
                    ]}
                  >
                    <Input
                      type="text"
                      id="domain_register_region"
                      placeholder="Область"
                    />
                  </Form.Item>
                </InputWrapper>
            ...
            <InputWrapper label="Адрес" id="domain_register_address">
              <Form.Item<FieldType>
                ...
                rules={[
                  {
                    max: 255,
                    message: "Максимальный размер адреса 255 символов",
                  },
            ...
            <InputWrapper label="Получатель" id="domain_register_recipeint">
              <Form.Item<FieldType>
                ...
                rules={[
                  ...
                  {
                    min: 2,
                    message: "Минимальный размер получателя 2 символа",
                  },
                ]}
              >
                <Input
                  type="text"
                  id="domain_register_recipeint"
